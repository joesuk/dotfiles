...
%\ProvidesClass{joe_icml}[2014/08/16 Example LaTeX class]
...
%\usepackage[round]{natbib} % commented out for conflict with ICML sty
\usepackage{url}
...
\usepackage{caption}
%\usepackage{bookmark} % suggested by slow arxiv.tex
...
%\newcommand{\theHalgorithm}{\arabic{algorithm}} % commented out because of ICML sty conflict
