...
%\ProvidesClass{joe_arxiv_preamble_edited}[2014/08/16 Example LaTeX class]
...
\usepackage{amsfonts}
\usepackage{graphicx}
%\usepackage[right=1in,left=1in,top=1in,bottom=1in]{geometry} % option clash with arxiv.sty
...
\newcommand\mycommfont[1]{\texttt{\textcolor{blue}{#1}}}
