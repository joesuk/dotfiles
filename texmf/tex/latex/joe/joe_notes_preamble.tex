...
\mdfdefinestyle{mdassumptionbox}{%
	...
	backgroundcolor=SpringGreen!10,
}
...
\declaretheorem[style=thmassumptionbox,name=Assumption]{assumption}
\declaretheorem[style=thmassumptionbox,name=Assumption,numbered=no]{assumption*}
