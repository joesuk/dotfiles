...
\declaretheorem[style=thmgreenbox,name=Example,numbered=no]{ex*}
\declaretheorem[style=thmgreenbox,name=Example,sibling=thm]{example}
\declaretheorem[style=thmgreenbox,name=Example,numbered=no]{example*}
...
\declaretheorem[style=thmgreenbox,name=Example,sibling=thm]{exercise}
