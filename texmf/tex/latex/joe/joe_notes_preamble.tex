...
\usepackage{outlines} % for clean nested bullet lists
...
\usepackage{stackengine,scalerel} % for \succeqsim in macros
...
\declaretheoremstyle[
	...
	spaceabove=7pt,
	headpunct={\hspace{0.5em}},
	headformat={
    \raisebox{0pt}[0pt][0pt]{%
      \colorbox{RoyalPurple!15}{%
        \strut\textcolor{RoyalPurple}{\NAME~\NUMBER}%
      }%
    }%
    \NOTE
  },
...
\declaretheorem[style=thmfactbox,name=Fact,sibling=thm]{fact}
\declaretheorem[style=thmfactbox,name=Fact,numbered=no]{fact*}
...
\Crefname{ex}{Ex.}{Ex.}
\Crefname{answer}{Ans.}{Ans.}
\Crefname{ques}{Ques.}{Ques.}
\Crefname{prob}{Prob.}{Prob.}
\Crefname{assumption}{Assum.}{Assum.}
...
% A reusable "recent changes" box
\newtcolorbox{recentchanges}[1][]{%
  enhanced,
  breakable,
  colback=cyan!8,              % aquamarine-ish fill
  colframe=Aquamarine,      % darker aquamarine border
  coltitle=black,
  fonttitle=\bfseries\color{White},
  title={Joe Update Log},
  left=1.2ex, right=1.2ex, top=1.0ex, bottom=1.0ex,
  boxrule=0.6pt,
  arc=2mm,
  drop shadow,
  #1
