...
" Recompile dwmblocks on config edit.
	...
	autocmd BufWritePost ~/.local/bin/statusbar/sb-fin !cd ~/; git add ~/.local/bin/statusbar/sb-fin && git commit -m "finance scripts"
...
hi Visual guifg=NONE guibg=#2c3b55 gui=NONE cterm=bold ctermbg=13 ctermfg=15
