...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/joesuk/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/joesuk/dotfiles/master/bootstrap/progs.csv"
